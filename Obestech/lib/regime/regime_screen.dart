    ...
    return Scaffold(
      ...
      appBar: AppBar(
        leading: Padding(
          ...
          child: Image.asset('lib/logo.png', fit: BoxFit.cover), // Remplace par le chemin de ton logo
        ),
        elevation: 0,
      ),
      body: Padding(
          ...
          children: [
                  ...
                  return Container(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor: selectedDayIndex == index ? Colors.blue : Colors.grey[300],
            ...
            if (!validated)
              ElevatedButton.icon(
                ...
                label: const Text("Valider la journée", style: TextStyle(color: Colors.white)), // Texte en blanc
                style: ElevatedButton.styleFrom(
